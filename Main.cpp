...
int main(int argc, char *argv[])
{
    ...
    a.setApplicationName("QForceStudio");
    a.setApplicationVersion("0.1");
    a.setOrganizationName("Logitech");
    a.setOrganizationDomain("com.logitech");

    MainWindow w;
    s_mainWindowInstance = &w;
